  ...
  return (
    <div className="group relative">
      ...
      <div className="space-y-1.5 px-2">
        <h4 className="text-xl font-black text-primary tracking-tight group-hover:text-primary transition-colors">{member.name}</h4>
        <p className="text-[11px] font-black uppercase tracking-[0.2em] transition-colors" style={{ color: accentColor }}>
          {member.role}
        </p>
        {member.organization && (
    ...
    <div className="space-y-15 md:space-y-32 py-10 md:pb-24">
      ...
      <section className="space-y-16">
        <div className="flex flex-col md:flex-row justify-between items-end gap-6">
          <div className="max-w-2xl">
            <h2 className="text-5xl md:text-6xl font-black text-primary tracking-tighter mb-6">
              Core Team <span className="text-indigo-600">Members</span>
            </h2>
            <p className="text-lg text-slate-500 font-medium leading-relaxed">
