...
function DonateSection() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const errorMsg = error.response?.data?.message || "Failed to submit donation. Please try again.";
      alert(errorMsg);
    } finally {
      setLoading(false);
    }
          ...
          {submitSuccess ? (
            <div className="text-center py-10 animate-in fade-in zoom-in duration-500">
              ...
              <p className="text-gray-600 mb-8">
                Your donation request has been recorded. Our team will verify the contribution soon. 
                If you chose Bank Transfer, please ensure you've completed the transfer.
              </p>
              <button 
            ...
            <div className="space-y-4">
              ...
              {errors.amount && (
                <p className="text-red-500 text-xs font-bold mt-1 ml-2">{errors.amount}</p>
              )}
            </div>
