...
const ProvinceEventsChart = ({ data }) => {
  ...
  return (
    <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm flex flex-col h-full">
      <h3 className="text-lg font-extrabold text-gray-900 mb-1">Events Overview</h3>
      <p className="text-xs font-semibold text-gray-400 uppercase tracking-widest mb-6">Events by Region</p>
...
export default ProvinceEventsChart;
