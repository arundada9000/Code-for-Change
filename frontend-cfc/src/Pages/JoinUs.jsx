...
const roleFields = {
  member: [
    ...
    },
    {
      ...
      label: "Tenure",
      type: "select",
      options: ["2025-2026", "2024-2025", "2023-2024", "2022-2023"],
      required: true,
    },
 ...
 "tech lead": [
  ...
  ippl: [
    ...
    { name: "code", label: "Code", type: "text", required: true },
    { name: "email", label: "Email", type: "email", required: true },
    { name: "contact", label: "Contact", type: "text", required: true, validation: "phone" },
    { name: "collegeName", label: "College Name", type: "text", required: false },
    { name: "faculty", label: "Faculty", type: "text", required: false },
    { name: "collegeSemester", label: "College Semester", type: "text", required: false },
    {
      name: "tenure",
      label: "Tenure",
      type: "select",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const payload = {
        ...
        role: role === 'member' ? 'gm' : role === 'executive' ? 'eb' : role === 'College Representative' ? 'cr' : role === 'tech lead' ? 'eb' : role,
