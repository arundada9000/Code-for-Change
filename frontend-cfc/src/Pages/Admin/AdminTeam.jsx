              ...
              >
                ...
                <div className="p-5 flex flex-col items-center text-center">
                  ...
                  <div className="flex gap-2">
                     {item.socialLinks?.linkedin && <a href={item.socialLinks.linkedin} target="_blank" rel="noopener noreferrer" className="w-8 h-8 flex items-center justify-center rounded-full bg-slate-200 text-slate-600 hover:bg-[#0077b5] hover:text-white transition-colors"><FaLinkedin /></a>}
                     {item.socialLinks?.twitter && <a href={item.socialLinks.twitter} target="_blank" rel="noopener noreferrer" className="w-8 h-8 flex items-center justify-center rounded-full bg-slate-200 text-slate-600 hover:bg-[#1DA1F2] hover:text-white transition-colors"><FaTwitter /></a>}
                     {item.socialLinks?.facebook && <a href={item.socialLinks.facebook} target="_blank" rel="noopener noreferrer" className="w-8 h-8 flex items-center justify-center rounded-full bg-slate-200 text-slate-600 hover:bg-[#1877F2] hover:text-white transition-colors"><FaFacebook /></a>}
                     {item.socialLinks?.instagram && <a href={item.socialLinks.instagram} target="_blank" rel="noopener noreferrer" className="w-8 h-8 flex items-center justify-center rounded-full bg-slate-200 text-slate-600 hover:bg-[#E1306C] hover:text-white transition-colors"><FaInstagram /></a>}
                     {item.socialLinks?.github && <a href={item.socialLinks.github} target="_blank" rel="noopener noreferrer" className="w-8 h-8 flex items-center justify-center rounded-full bg-slate-200 text-slate-600 hover:bg-[#333] hover:text-white transition-colors"><FaGithub /></a>}
                     {item.socialLinks?.website && <a href={item.socialLinks.website} target="_blank" rel="noopener noreferrer" className="w-8 h-8 flex items-center justify-center rounded-full bg-slate-200 text-slate-600 hover:bg-emerald-600 hover:text-white transition-colors"><FaGlobe /></a>}
                  </div>
                </div>
              </div>
            ))}
